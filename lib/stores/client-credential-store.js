...
function ClientCredentialStore(name) {
    var self = this
    ...
    self.on('app_mount', function() {
        console.log('ClientCredentialStore app_mount');
    ...
    self.on('app_unmount', function() {
        console.log('ClientCredentialStore app_unmount');
    ...
    self.on(self._removeItemEVT, function(value,filterFunc) {
        console.log('handle:',self._removeItemEVT,value,filterFunc);
        ...
        if(filterFunc){
            ...
            // TODO.  the filterFunc needs to return an array, perhaps one with all the items already removed.
...
if (typeof(module) !== 'undefined') module.exports = ClientCredentialStore;
